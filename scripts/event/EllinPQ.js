...
function setup(player, diff) {
    var eim = em.newInstance("Ellin" + player.getName());
    var level = player.getTotalLevel();
    eim.setProperty("level", level);

    eim.setProperty("stageclear", 0);
    eim.setProperty("statusStg4", 0);
    eim.getInstanceMap(930000500).shuffleReactors();
