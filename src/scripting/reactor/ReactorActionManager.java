...
public class ReactorActionManager extends AbstractPlayerInteraction {
    ...
    private static List<ReactorDropEntry> generateDropList(List<ReactorDropEntry> drops, double dropRate, boolean meso, int mesoChance, int minItems) {
        MapleItemInformationProvider ii = MapleItemInformationProvider.getInstance();
    ...
    public void spawnMonster(int id, int qty, Point pos) {
        for (int i = 0; i < qty; i++) {
            reactor.getMap().spawnMonsterOnGroundBelow(MapleLifeFactory.getMonster(id, client.getChannelServer().getId()), pos);
        }
    }

    @Override
    public void spawnMonster(int id, int x, int y) {
        reactor.getMap().spawnMonsterOnGroundBelow(MapleLifeFactory.getMonster(id, client.getChannelServer().getId()), new Point(x, y));
    }
    ...
    public void spawnFakeMonster(int id) {
        reactor.getMap().spawnFakeMonsterOnGroundBelow(MapleLifeFactory.getMonster(id, client.getChannelServer().getId()), getPosition());
    }

    public void spawnFakeMonster(int id, int x, int y) {
        reactor.getMap().spawnFakeMonsterOnGroundBelow(MapleLifeFactory.getMonster(id, client.getChannelServer().getId()), new Point(x, y));
    }
