...
function monsterValue(eim, mobId) {
    ...
    var amount = eim.getIntProperty("stage") * eim.getChannel();
    if (eim.getdojorate()) {
        amount *= 2;
    }
    ...
    if (mobId >= eim.getIntProperty("startmob") && mobId < eim.getIntProperty("endmob")) {
        map.spawnMonsterWithEffect(MapleLifeFactory.getMonsterRankLink(mobId + 1, eim.getChannel(), 2, false), 15, new java.awt.Point(Randomizer.rand(-250, 250), 0));
    }
