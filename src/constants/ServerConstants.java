...
public class ServerConstants {
    ...
    public static final boolean USE_IP_VALIDATION = false;           //Enables IP checking when logging in.
    ...
    public static final boolean USE_BUFF_EVERLASTING = true;       //Every applied buff on players holds expiration time so high it'd be considered permanent. Suggestion thanks to Vcoc.
    ...
    public static final boolean USE_WHOLE_SERVER_RANKING = true;   //Enables a ranking pool made from every character registered on the server for the "ranks" command, instead of separated by worlds.
    ...
    public static final float EXP_SPLIT_MVP_MOD = 0.10f;
    public static final float EXP_SPLIT_COMMON_MOD = 1.0f;
    public static final float PARTY_BONUS_EXP_RATE = 1.0f;          //Rate for the party exp bonus reward.
    
    //Miscellaneous Configuration
    public static String TIMEZONE = "GMT-7";
    ...
    public static final int ITEM_LIMIT_ON_MAP = 2500;            //Max number of items allowed on a map.
    ...
    //Guild Configuration
    public static final int CREATE_GUILD_MIN_PARTNERS = 1;       //Minimum number of members on Guild Headquarters to establish a new guild.
    ...
    public static final int MAX_EQUIPMNT_LVLUP_STAT_UP = 32000; //Max stat upgrade an equipment can have on a levelup.
    public static final int MAX_EQUIPMNT_STAT = 999999999;          //Max stat on an equipment by leveling up.
    ...
    public static final double PET_AUTOHP_RATIO = 1.00;         //Will automatically consume potions until given ratio of the MaxHP/MaxMP is reached.
    public static final double PET_AUTOMP_RATIO = 1.00;
