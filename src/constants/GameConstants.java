...
public class GameConstants {
    ...
    public static boolean isGMSkills(final int skill) {
        return skill >= 8001000 && skill <= 8001001;
    }
    ...
    public static boolean isBonusMap(int mapid) {
        if (mapid >= 81000 && mapid < 83000) {
            if (mapid == 82100 || mapid == 82101) {
                return false;
            }
            return true;
        }
        if (mapid >= 90000 && mapid < 90100) {
            return true;
        }
        if (mapid >= 98000 && mapid <= 98005) {
            return true;
        }
        return false;
    }
