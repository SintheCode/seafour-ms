...
function setup(player, scale) {
    var eim = em.newInstance("BigBoss" + player.getName());
...
function start(eim) {
    ...
    map.spawnMonsterOnGroundBelow(MapleLifeFactory.getMonsterCustomRank(9400112, eim.getChannel(), (eim.getIntProperty("scale") - 1), false), new java.awt.Point(Randomizer.rand(-700, 800), 160), false);
    map.spawnMonsterOnGroundBelow(MapleLifeFactory.getMonsterCustomRank(9400112, eim.getChannel(), (eim.getIntProperty("scale") - 1), false), new java.awt.Point(Randomizer.rand(-700, 800), 160), false);
