...
function start(eim) {
    var map = eim.getMapInstance(eventMapId);
    for (var i = 1; i <= 5; i++) {
        map.spawnMonsterWithEffect(MapleLifeFactory.getMonster(8860002, eim.getChannel()), 15, new java.awt.Point(-380, -590));
    }
    for (var i = 1; i <= 5; i++) {
        map.spawnMonsterWithEffect(MapleLifeFactory.getMonster(8860002, eim.getChannel()), 15, new java.awt.Point(650, -590));
    }
    for (var i = 1; i <= 10; i++) {
        map.spawnMonsterWithEffect(MapleLifeFactory.getMonster(8860001, eim.getChannel()), 15, new java.awt.Point(Randomizer.rand(-380, 650), -590));
    }
    map.spawnMonsterWithEffect(MapleLifeFactory.getMonster(8860000, eim.getChannel()), 15, new java.awt.Point(130, -700));
