...
function setup(player, lobbyId) {
    var eim = em.newInstance("MK_PrimeMinister2_" + player);
    respawn(eim);
...
function respawn(eim) {
    if (primeMinisterCheck(eim)) {
        ...
        weddinghall.spawnMonsterOnGroundBelow(MapleLifeFactory.getMonster(mobId, eim.getChannel()), new java.awt.Point(292, 143));
    } else {
