...
var stage2Rects = Array(new java.awt.Rectangle(-755, -132, 4, 218), new java.awt.Rectangle(-721, -340, 4, 166), new java.awt.Rectangle(-586, -326, 4, 150), new java.awt.Rectangle(-483, -181, 4, 222));
var stage3Rects = Array(new java.awt.Rectangle(608, -180, 140, 50), new java.awt.Rectangle(791, -117, 140, 45),
        new java.awt.Rectangle(958, -180, 140, 50), new java.awt.Rectangle(876, -238, 140, 45),
        new java.awt.Rectangle(702, -238, 140, 45));
var stage4Rects = Array(new java.awt.Rectangle(910, -236, 35, 5), new java.awt.Rectangle(877, -184, 35, 5),
        new java.awt.Rectangle(946, -184, 35, 5), new java.awt.Rectangle(845, -132, 35, 5),
        new java.awt.Rectangle(910, -132, 35, 5), new java.awt.Rectangle(981, -132, 35, 5));
...
function clearStage(stage, eim, curMap) {
    eim.setProperty("stageclear", stage);
...
function action(mode, type, selection) {
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (eim.getProperty("stageclear") == stage) {
                if (stage < 5) {
