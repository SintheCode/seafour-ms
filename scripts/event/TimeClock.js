...
function setup(player, scale) {
    var eim = em.newInstance("TimeClock" + player.getName());
...
function start(eim) {
    ...
    map.spawnMonsterOnGroundBelow(MapleLifeFactory.getMonsterCustomRank(8910000, eim.getChannel(), 6, false), new java.awt.Point(700, 380));
}
