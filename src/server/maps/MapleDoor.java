    ...
    public MapleDoor(MapleCharacter owner, Point targetPosition) {
        ...
        if (target.canDeployDoor(targetPosition)) {
            ...
            if (posStatus == null) {
                ...
                if (townPortal != null) {
                    this.areaDoor = new MapleDoorObject(owner, town, target, townPortal.getId(), targetPosition, townPortal.getPosition());
                    this.townDoor = new MapleDoorObject(owner, target, town, -1, townPortal.getPosition(), targetPosition);
